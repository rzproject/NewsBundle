            ...
            ->children()
                ...
                ->arrayNode('templates')
                    ...
                    ->children()
                        ...
                        ->scalarNode('collection_html')->defaultValue('RzNewsBundle:Post:collection.html.twig')->end()
                        ->scalarNode('collection_rss')->defaultValue('RzNewsBundle:Post:collection.rss.twig')->end()
                        ->scalarNode('tag_html')->defaultValue('RzNewsBundle:Post:tag.html.twig')->end()
